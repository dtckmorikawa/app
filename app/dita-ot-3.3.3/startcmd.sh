...
NEW_CLASSPATH="$DITA_DIR/lib/Saxon-HE-9.8.0-14.jar:$NEW_CLASSPATH"
NEW_CLASSPATH="$DITA_DIR/lib/ant-apache-resolver-1.10.5.jar:$NEW_CLASSPATH"
...
NEW_CLASSPATH="$DITA_DIR/lib/jackson-annotations-2.9.0.jar:$NEW_CLASSPATH"
NEW_CLASSPATH="$DITA_DIR/lib/jackson-core-2.9.8.jar:$NEW_CLASSPATH"
NEW_CLASSPATH="$DITA_DIR/lib/jackson-databind-2.9.8.jar:$NEW_CLASSPATH"
...
NEW_CLASSPATH="$DITA_DIR/plugins/org.dita.pdf2.fop/lib/fontbox-2.0.13.jar:$NEW_CLASSPATH"
NEW_CLASSPATH="$DITA_DIR/plugins/org.dita.pdf2.fop/lib/fop-pdf-images-2.3.jar:$NEW_CLASSPATH"
NEW_CLASSPATH="$DITA_DIR/plugins/org.dita.pdf2.fop/lib/pdfbox-2.0.13.jar:$NEW_CLASSPATH"
...
NEW_CLASSPATH="$DITA_DIR/plugins/org.lwdita/lib/org.lwdita-2.3.0.jar:$NEW_CLASSPATH"
