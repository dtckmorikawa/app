...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:attribute-set name="common.title">
    <xsl:attribute name="font-family">GenYoMin JP TTF Bold, IPAMincho, Arial Unicode MS, Helvetica</xsl:attribute>
  </xsl:attribute-set>
...
<!--Topic numbering-->
  ...
  <xsl:attribute-set name="topic.title">
    <xsl:attribute name="font-family">GenYoMin JP TTF Regular, IPAMincho, Arial Unicode MS, Helvetica</xsl:attribute>
    <xsl:attribute name="font-size">10.6pt</xsl:attribute>
    <xsl:attribute name="font-weight">normal</xsl:attribute>
  ...
  <!--table bottom border-->
  <xsl:attribute-set name="table.border__bottom">
    <xsl:attribute name="border-after-style">solid</xsl:attribute>
    <xsl:attribute name="border-after-width">1pt</xsl:attribute>
    <xsl:attribute name="border-after-color">black</xsl:attribute>
  </xsl:attribute-set>  
