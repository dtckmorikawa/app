        ...
        <fo:static-content flow-name="first-body-header"> 
            <fo:block xsl:use-attribute-sets="__body__first__header">
                ...
                <xsl:call-template name="getVariable">
                    <xsl:with-param name="id" select="'First page header'"/>
                    <xsl:with-param name="params">
                        <title>
                        <fo:block xsl:use-attribute-sets="__body__first__header__booktitle">
                            <xsl:value-of select="$bc.bookTitle"/>
                        </fo:block>
                        <fo:block xsl:use-attribute-sets="__body__first__header__shortdesc">
                            <xsl:value-of select="$bc.shortDesc"/>
                        </fo:block>
                        </title>
                    </xsl:with-param>
                </xsl:call-template>
