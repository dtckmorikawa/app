...
return [
    ...
    'image_upload_enabled' => true, // true or false, if image and video uploading is allowed.
    'blog_upload_dir' => "blog_images", // this should be in public_path() (i.e. /public/blog_images), and should be writable
    
    'video_upload_dir' => "blog_videos", // this should be in public_path() (i.e. /public/blog_videos), and should be writable
    ...
    'captcha' => [
        ...
        'basic_question' => "白の反対の色は？", // a simple captcha question to always ask (if captcha_type is set to 'basic'
        'basic_answers' => "黒,くろ", // comma separated list of possible answers. Don't worry about case.
    ],
